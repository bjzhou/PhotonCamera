...
.method public static synthetic access$000(Lcom/custom/lut/RotSeek;)I
    .locals 0

    iget p0, p0, Lcom/custom/lut/RotSeek;->currentValue:I

    return p0
.end method

.method public static synthetic access$002(Lcom/custom/lut/RotSeek;I)I
    .locals 0
...
.method public static synthetic access$100(Lcom/custom/lut/RotSeek;)Landroid/widget/SeekBar$OnSeekBarChangeListener;
    .locals 0

    iget-object p0, p0, Lcom/custom/lut/RotSeek;->mListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;

    return-object p0
.end method

.method public static synthetic access$200(Lcom/custom/lut/RotSeek;)Z
    .locals 0

    iget-boolean p0, p0, Lcom/custom/lut/RotSeek;->autoscroll:Z

    return p0
.end method

.method public static synthetic access$202(Lcom/custom/lut/RotSeek;Z)Z
    .locals 0
...
.method public static synthetic access$300(Lcom/custom/lut/RotSeek;)I
    .locals 0

    iget p0, p0, Lcom/custom/lut/RotSeek;->currentPosToDraw:I

    return p0
.end method

.method public static synthetic access$320(Lcom/custom/lut/RotSeek;I)I
    .locals 1
...
.method public static synthetic access$400(Lcom/custom/lut/RotSeek;)I
    .locals 0

    iget p0, p0, Lcom/custom/lut/RotSeek;->distanceInPixelFromLastSwipe:I

    return p0
.end method

.method public static synthetic access$402(Lcom/custom/lut/RotSeek;I)I
    .locals 0
...
.method public static synthetic access$408(Lcom/custom/lut/RotSeek;)I
    .locals 2
...
.method public static synthetic access$410(Lcom/custom/lut/RotSeek;)I
    .locals 2
...
.method public static synthetic access$500(Lcom/custom/lut/RotSeek;)I
    .locals 0

    iget p0, p0, Lcom/custom/lut/RotSeek;->realMax:I

    return p0
.end method

.method public static synthetic access$600(Lcom/custom/lut/RotSeek;)I
    .locals 0

    iget p0, p0, Lcom/custom/lut/RotSeek;->realMin:I

    return p0
.end method

.method public static synthetic access$700(Lcom/custom/lut/RotSeek;)[Ljava/lang/String;
    .locals 0

    iget-object p0, p0, Lcom/custom/lut/RotSeek;->Values:[Ljava/lang/String;
...
.method private init(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p1, p0, Lcom/custom/lut/RotSeek;->handler:Landroid/os/Handler;

    new-instance p1, Landroid/graphics/Paint;

    invoke-direct {p1}, Landroid/graphics/Paint;-><init>()V

    iput-object p1, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;

    const/4 p2, 0x1

    invoke-virtual {p1, p2}, Landroid/graphics/Paint;->setAntiAlias(Z)V

    iget-object p1, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;
    ...
    iget p1, p0, Lcom/custom/lut/RotSeek;->textsize:I

    invoke-direct {p0, p1}, Lcom/custom/lut/RotSeek;->convertDpiToPixel(I)F

    move-result p1

    float-to-int p1, p1

    iput p1, p0, Lcom/custom/lut/RotSeek;->textsize:I

    iget p1, p0, Lcom/custom/lut/RotSeek;->currentValue:I

    const/4 p2, 0x0

    invoke-virtual {p0, p1, p2}, Lcom/custom/lut/RotSeek;->setProgress(IZ)V
...
.method public SetStringValues([Ljava/lang/String;)V
    ...
    iput p1, p0, Lcom/custom/lut/RotSeek;->allItemsHeight:I
    ...
    iput p1, p0, Lcom/custom/lut/RotSeek;->realMax:I
...
.method public checkifCurrentValueHasChanged()V
    ...
    new-instance v1, Lcom/custom/lut/RotSeek$1;

    invoke-direct {v1, p0}, Lcom/custom/lut/RotSeek$1;-><init>(Lcom/custom/lut/RotSeek;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    iget v1, p0, Lcom/custom/lut/RotSeek;->textsize:I
    ...
    iget v2, p0, Lcom/custom/lut/RotSeek;->currentValue:I
    ...
    iget-object v4, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;

    invoke-direct {p0, v2}, Lcom/custom/lut/RotSeek;->switchAlpha(I)I

    move-result v2

    invoke-virtual {v4, v2}, Landroid/graphics/Paint;->setAlpha(I)V

    iget-object v2, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;

    const/high16 v4, 0x3f800000    # 1.0f

    invoke-virtual {v2, v4}, Landroid/graphics/Paint;->setStrokeWidth(F)V

    iget v2, p0, Lcom/custom/lut/RotSeek;->itemHeight:I

    mul-int v4, v2, v0

    iget v5, p0, Lcom/custom/lut/RotSeek;->textsize:I

    add-int/2addr v4, v5

    iget v6, p0, Lcom/custom/lut/RotSeek;->currentPosToDraw:I
    ...
    invoke-direct {p0, v3}, Lcom/custom/lut/RotSeek;->convertDpiToPixel(I)F
    ...
    iget-object v10, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;
    ...
    iget-object v3, p0, Lcom/custom/lut/RotSeek;->paint:Landroid/graphics/Paint;
    ...
    iget v0, p0, Lcom/custom/lut/RotSeek;->viewWidth:I
...
.method public onSizeChanged(IIII)V
    ...
    iput p1, p0, Lcom/custom/lut/RotSeek;->itemHeight:I

    iget-object p3, p0, Lcom/custom/lut/RotSeek;->Values:[Ljava/lang/String;
    ...
    iput p3, p0, Lcom/custom/lut/RotSeek;->allItemsHeight:I
    ...
    iput p4, p0, Lcom/custom/lut/RotSeek;->realMin:I
    ...
    iput p3, p0, Lcom/custom/lut/RotSeek;->realMax:I
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget v0, p0, Lcom/custom/lut/RotSeek;->startY:I
    ...
    invoke-direct {p0, v0, v1}, Lcom/custom/lut/RotSeek;->getSignedDistance(II)I
    ...
    :cond_1
    iput-boolean v2, p0, Lcom/custom/lut/RotSeek;->sliderMoving:Z
    ...
    iput v0, p0, Lcom/custom/lut/RotSeek;->distanceInPixelFromLastSwipe:I

    iget v1, p0, Lcom/custom/lut/RotSeek;->currentPosToDraw:I

    sub-int/2addr v1, v0

    mul-int/lit8 v0, v1, -0x1

    iget v2, p0, Lcom/custom/lut/RotSeek;->realMax:I

    if-ge v0, v2, :cond_3

    iget v2, p0, Lcom/custom/lut/RotSeek;->realMin:I
    ...
    iput p1, p0, Lcom/custom/lut/RotSeek;->startY:I
    ...
    :cond_4
    iget-boolean p1, p0, Lcom/custom/lut/RotSeek;->sliderMoving:Z

    if-eqz p1, :cond_a

    iput-boolean v1, p0, Lcom/custom/lut/RotSeek;->sliderMoving:Z

    iget-object p1, p0, Lcom/custom/lut/RotSeek;->mListener:Landroid/widget/SeekBar$OnSeekBarChangeListener;
    ...
    :cond_5
    iget p1, p0, Lcom/custom/lut/RotSeek;->distanceInPixelFromLastSwipe:I
    ...
    :cond_7
    iput-boolean v2, p0, Lcom/custom/lut/RotSeek;->autoscroll:Z
    ...
    invoke-virtual {p0, p1, v2}, Lcom/custom/lut/RotSeek;->setProgress(IZ)V
    ...
    iput-boolean v1, p0, Lcom/custom/lut/RotSeek;->autoscroll:Z
...
.method public setProgress(IZ)V
    ...
    iput p1, p0, Lcom/custom/lut/RotSeek;->currentPosToDraw:I
    ...
    iget-object p1, p0, Lcom/custom/lut/RotSeek;->handler:Landroid/os/Handler;

    new-instance p2, Lcom/custom/lut/RotSeek$3;

    invoke-direct {p2, p0}, Lcom/custom/lut/RotSeek$3;-><init>(Lcom/custom/lut/RotSeek;)V
