.class public final Lcom/agc/glide/util/Util;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lcom/agc/glide/util/Util;->HEX_CHAR_ARRAY:[C

    const/16 v0, 0x40

    new-array v0, v0, [C

    sput-object v0, Lcom/agc/glide/util/Util;->SHA_256_CHARS:[C
...
.method public static bothBaseRequestOptionsNullEquivalentOrEquals(Lcom/agc/glide/request/BaseRequestOptions;Lcom/agc/glide/request/BaseRequestOptions;)Z
    .locals 0
...
.method public static bothModelsNullEquivalentOrEquals(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    :cond_1
    instance-of v0, p0, Lcom/agc/glide/load/model/Model;

    if-eqz v0, :cond_2

    check-cast p0, Lcom/agc/glide/load/model/Model;

    invoke-interface {p0, p1}, Lcom/agc/glide/load/model/Model;->isEquivalentTo(Ljava/lang/Object;)Z
...
.method private static bytesToHex([B[C)Ljava/lang/String;
    ...
    sget-object v3, Lcom/agc/glide/util/Util;->HEX_CHAR_ARRAY:[C
...
.method public static getBitmapByteSize(IILandroid/graphics/Bitmap$Config;)I
    ...
    invoke-static {p2}, Lcom/agc/glide/util/Util;->getBytesPerPixel(Landroid/graphics/Bitmap$Config;)I
...
.method public static getBytesPerPixel(Landroid/graphics/Bitmap$Config;)I
    ...
    :cond_0
    sget-object v0, Lcom/agc/glide/util/Util$1;->$SwitchMap$android$graphics$Bitmap$Config:[I
...
.method private static getUiThreadHandler()Landroid/os/Handler;
    ...
    sget-object v0, Lcom/agc/glide/util/Util;->mainThreadHandler:Landroid/os/Handler;

    if-nez v0, :cond_1

    const-class v0, Lcom/agc/glide/util/Util;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lcom/agc/glide/util/Util;->mainThreadHandler:Landroid/os/Handler;
    ...
    sput-object v1, Lcom/agc/glide/util/Util;->mainThreadHandler:Landroid/os/Handler;
...
.method public static hashCode(F)I
    ...
    invoke-static {p0, v0}, Lcom/agc/glide/util/Util;->hashCode(FI)I
...
.method public static hashCode(FI)I
    ...
    invoke-static {p0, p1}, Lcom/agc/glide/util/Util;->hashCode(II)I
...
.method public static hashCode(I)I
    ...
    invoke-static {p0, v0}, Lcom/agc/glide/util/Util;->hashCode(II)I
...
.method public static hashCode(Z)I
    ...
    invoke-static {p0, v0}, Lcom/agc/glide/util/Util;->hashCode(ZI)I
...
.method public static isValidDimensions(II)Z
    ...
    invoke-static {p0}, Lcom/agc/glide/util/Util;->isValidDimension(I)Z

    move-result p0

    if-eqz p0, :cond_0

    invoke-static {p1}, Lcom/agc/glide/util/Util;->isValidDimension(I)Z
...
.method public static postOnUiThread(Ljava/lang/Runnable;)V
    ...
    invoke-static {}, Lcom/agc/glide/util/Util;->getUiThreadHandler()Landroid/os/Handler;
...
.method public static sha256BytesToHex([B)Ljava/lang/String;
    ...
    sget-object v0, Lcom/agc/glide/util/Util;->SHA_256_CHARS:[C

    monitor-enter v0

    :try_start_0
    invoke-static {p0, v0}, Lcom/agc/glide/util/Util;->bytesToHex([B[C)Ljava/lang/String;
