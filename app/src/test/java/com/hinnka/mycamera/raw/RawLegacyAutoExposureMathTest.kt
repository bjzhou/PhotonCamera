...
class RawLegacyAutoExposureMathTest {
    @Test
    ...
    fun solverRecoversOneStopAcrossMixedToneDistribution() {
        ...
        val solvedEv = RawLegacyAutoExposureMath.solve { exposureEv ->
            ...
            RawLegacyAutoExposureMath.evaluate(
                reference = reference,
    ...
    fun referenceWithBlackAndWhiteEndpointsHasDefinedBrightness() {
        ...
        val reference = RawLegacyAutoExposureMath.buildReference(
            pixels = pixels,
            width = 8,
            height = 8,
            left = 0,
    ...
    private fun buildReference(
        ...
        width: Int,
        height: Int,
    ): RawLegacyAutoExposureMath.Reference {
        return RawLegacyAutoExposureMath.buildReference(
            pixels = pixels,
            width = width,
            height = height,
            left = 0,
