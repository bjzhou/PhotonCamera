...
internal object MgcSabreRejectionTuning {
    ...
    /**
     * GenerateRejectionTexture scales both flow-variation thresholds by the guide width.
     * Recovered from libgcastartup.so 0x3492dd0..0x3492e84.
     */
    fun flowVariationThreshold(guideWidth: Int): Float {
        require(guideWidth > 0)
        return REFERENCE_GUIDE_WIDTH / guideWidth.toFloat() *
