...
/** Thin lifecycle wrapper around the native adaptive grid exposure solver. */
internal object RawViewfinderExposureNativeBridge {
    init {
    ...
    class Solver private constructor(
        ...
        fun submitCandidate(exposureEv: Float, frame: RawExposurePreviewFrame): Boolean {
            check(handle != 0L) { "Native exposure solver is closed" }
        ...
        companion object {
            fun create(reference: RawExposurePreviewFrame): Solver? {
