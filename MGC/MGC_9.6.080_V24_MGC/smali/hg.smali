...
.method public final D(Lfx;)V
    ...
    :goto_a
    invoke-interface {p0, p1}, Lfv;->D(Lfx;)V
    ...
    :goto_1e
    invoke-virtual {v0, p1}, Lhdu;->y(Landroid/view/Menu;)V
    ...
    :goto_2d
    iget-object v0, v0, Landroid/support/v7/widget/Toolbar;->C:Lhdu;
    ...
    :goto_36
    iget-object p0, p0, Landroid/support/v7/widget/Toolbar;->A:Lfv;
    ...
    :goto_3d
    iget-object v0, v0, Lep;->a:Landroid/view/Window$Callback;
    ...
    :goto_3e
    iget-object p0, p0, Landroid/support/v7/widget/ActionMenuView;->d:Lfv;
...
.method public final H(Lfx;Landroid/view/MenuItem;)Z
    ...
    :goto_13
    invoke-virtual {p1, p2}, Lhdu;->z(Landroid/view/MenuItem;)Z
    ...
    :goto_1c
    iget-object p1, p1, Landroid/support/v7/widget/Toolbar;->C:Lhdu;
    ...
    :goto_1d
    iget-object p0, p0, Landroid/support/v7/widget/ActionMenuView;->e:Landroidx/wear/ambient/AmbientMode$AmbientController;
    ...
    :goto_28
    iget-object p0, p0, Landroid/support/v7/widget/Toolbar;->D:Landroidx/wear/ambient/AmbientMode$AmbientController;
