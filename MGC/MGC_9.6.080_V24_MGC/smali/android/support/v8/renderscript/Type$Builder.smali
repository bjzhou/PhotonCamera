...
.method public constructor <init>(Landroid/support/v8/renderscript/RenderScript;Landroid/support/v8/renderscript/Element;)V
    ...
    :goto_4
    invoke-static {p2}, Landroid/support/v8/renderscript/Type$Builder;->WXYgfXgCqskHxrEX(Landroid/support/v8/renderscript/BaseObj;)V
...
.method public static BkIOuPhcSiJVThHJ(Landroid/support/v8/renderscript/Type;)V
    .locals 0
...
.method public static WXYgfXgCqskHxrEX(Landroid/support/v8/renderscript/BaseObj;)V
    .locals 0
    ...
    :goto_0
    invoke-virtual {p0}, Landroid/support/v8/renderscript/BaseObj;->checkValid()V
...
.method public static fEYXiZPItjzwazyj(Landroid/support/v8/renderscript/BaseObj;Landroid/support/v8/renderscript/RenderScript;)J
    .locals 2
...
.method public static lOBiSXbfEAVZcyqR(Landroid/support/v8/renderscript/RenderScript;JIIIZZI)J
    .locals 2
...
.method public create()Landroid/support/v8/renderscript/Type;
    ...
    :goto_b
    const-string v0, "Cube maps require 2D Types."
    ...
    :goto_e
    invoke-static {v0, v1}, Landroid/support/v8/renderscript/Type$Builder;->fEYXiZPItjzwazyj(Landroid/support/v8/renderscript/BaseObj;Landroid/support/v8/renderscript/RenderScript;)J
    ...
    :goto_11
    iput p0, v2, Landroid/support/v8/renderscript/Type;->mDimYuv:I
    ...
    :goto_13
    sget-object v0, Lcom/google/android/apps/camera/debug/metrics/Rn/hhAHoOiyE;->obnPNLHlXEBKhx:Ljava/lang/String;
    ...
    :goto_15
    const-string v0, "YUV only supports basic 2D."
    ...
    :goto_16
    invoke-static {v2}, Landroid/support/v8/renderscript/Type$Builder;->BkIOuPhcSiJVThHJ(Landroid/support/v8/renderscript/Type;)V
    ...
    :goto_3f
    invoke-static/range {v1 .. v9}, Landroid/support/v8/renderscript/Type$Builder;->lOBiSXbfEAVZcyqR(Landroid/support/v8/renderscript/RenderScript;JIIIZZI)J
    ...
    :goto_44
    const-string v0, "Both X and Y dimension required when Z is present."
    ...
    :goto_59
    sget-object v0, Lcom/google/android/apps/camera/imax/cyclops/capture/xzG/uebAI;->WhvMbOUDmTNF:Ljava/lang/String;
    ...
    :goto_5a
    iget p0, p0, Landroid/support/v8/renderscript/Type$Builder;->mYuv:I
...
.method public setYuvFormat(I)Landroid/support/v8/renderscript/Type$Builder;
    ...
    :goto_7
    const-string p1, "Only NV21 and YV12 are supported.."
...
.method public setZ(I)Landroid/support/v8/renderscript/Type$Builder;
    ...
    :goto_2
    const-string p1, "Values of less than 1 for Dimension Z are not valid."
