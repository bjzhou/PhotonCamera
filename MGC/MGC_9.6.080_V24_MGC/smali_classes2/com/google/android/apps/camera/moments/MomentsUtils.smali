...
# direct methods
.method public static a(Lpge;)Lsui;
    .locals 2
    ...
    :goto_1
    invoke-direct {v1, v0}, Lkig;-><init>(Lsuu;)V
...
.method public static b(Lkft;Llsi;Ljava/util/Collection;)Z
    .locals 4
    ...
    :goto_5
    invoke-interface {p0}, Lkft;->e()Lrss;
    ...
    :goto_b
    invoke-virtual {p1, p0, p2, v2}, Llsi;->a(Llso;Ljava/util/Collection;Z)Llsn;
    ...
    :goto_d
    invoke-interface {p0}, Lkft;->f()Lrss;
    ...
    :goto_25
    invoke-interface {p0}, Lkft;->d()Llso;
...
.method public static c(Lkft;FLlsi;Ljava/util/Collection;)Z
    .locals 3
    ...
    :goto_c
    invoke-virtual {p2, p0, p3, v0}, Llsi;->a(Llso;Ljava/util/Collection;Z)Llsn;
